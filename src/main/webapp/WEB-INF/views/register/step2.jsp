...
<script>
	function CheckForm(Join) {
		...
		//체크박스 체크여부 확인 [하나]
		var chk1 = document.signup.agreeCheck1.checked;
		var chk2 = document.signup.agreeCheck2.checked;

		if (!chk1) {
			alert('약광에 동의하지 않으면 회원가입 할 수 없습니다.');
			return false;
		}
		if (!chk2) {
			alert('14세 이하는 회원가입할수 없습니다.');
			return false;
		}
...
<link rel="canonical" href="https://auctioncourt.xyz/signup">
...
<meta property="og:url" content="https://auctioncourt.xyz/signup" />
...
<body class="display display-home display desktop  document-loading">
	...
	<div class="hide">
		<div id="data_div" data-memberNo="50936" data-id="" data-userName=""
			...
			data-pageLink="signup" data-pageNo="0" data-pageType="systemPage"
			...
			data-displayType="display" data-defaultURI="/miniromi/signup"
			...
			<div class="row row-main desktop">
				...
				<div class="column header-right">
					...
					<div id="headerCartAndCustomer"
						...
						<a id="headerCustomer"
							class="headerCustomer desktop site-element-child" href="login">
							<span class="headerCustomerContent" data-type="english">LOG
								IN</span> <span class="headerCustomerContent" data-type="korean">로그인</span>
				...
				<div class="column-wrapper one-column">
					<div class="signup field">
						...
						<form:form role="form" commandName="registerRequest"
							action="step3" method="post" onSubmit="return CheckForm(this)">

							<div class="content designSettingElement text-body">
								<div class="row">
									<span class="title">아이디(ID) *</span>
								...
								<div class="row">
									<span class="title">이메일(EMAIL) *</span>
								...
								<div class="row">
									...
									<form:password class="form-control"
										placeholder="Password Check" path="cpw" />
									<form:errors path="cpw" />
								</div>

								<div class="row">
									<span class="title designSettingElement text-body">휴대폰
										번호 </span>
									<form:input type="tel" class="form-control" placeholder="Phone"
										path="phone" maxlength="14" />
									<form:errors path="phone" />
								</div>

								<div class="row" style="font-size: 14px; margin-bottom: 30px;">
									<span class="title" style="margin-bottom: 22px;">성별 </span>
									<div class="i-b" style="margin-right: 30px;">
										<input id="male" type="radio" name="gender" value="남">
										<label for="male"
											class="trans-fast designSettingElement text-body">남자</label>
									</div>
									<div class="i-b">
								...
								<div class="btn-wrapper">
									...
									<button type="submit" class="designSettingElement button">가입하기</button>
